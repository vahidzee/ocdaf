...
def main():
    ...
    nx.draw(cli.datamodule.dataset.dag, with_labels=True)
    plt.show()
    print(cli.datamodule.dataset.explanation)
    plt.hist(cli.datamodule.dataset.samples[0], density=True, bins=100, alpha=0.5, label="x0")
    plt.hist(cli.datamodule.dataset.samples[1], density=True, bins=100, alpha=0.5, label="x1")
    plt.hist(cli.datamodule.dataset.samples[2], density=True, bins=100, alpha=0.5, label="x2")
    plt.legend()
    plt.show()
